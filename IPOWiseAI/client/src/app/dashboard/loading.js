...
export default function Loading() {
    ...
    return (
        <div className=" static backdrop-blur-sm min-h-screen flex items-center justify-center flex-col">
            ...
            <div className=" font-xl text-white font-semibold p-2">Analyzing...</div>
            <div className=" font-xl text-white font-semibold p-2">It might take some time, so please be patient</div>
        </div>
    )
}